...
import { useProduct, useCart, productGetters, useReviews, reviewGetters } from '~/composables';
...
export default {
  ...
  setup(props, context) {
    ...
    const { reviews: productReviews, search: searchReviews } = useReviews('productReviews');
